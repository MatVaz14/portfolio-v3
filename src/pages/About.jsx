...
const About = () => {
	return (
		<section id="about" className="section-about bg-primary">
			<img src={divSection} alt="div" width="50%" height="30px" className="style-div-img"/>
			<img src={AboutMe.image} alt="AboutMe" width="400px" height="400px" className="style-img-about"/>
			<div className="container-text-about" data-aos="fade-left">
				<h1>{AboutMe.textTitle} <span>{AboutMe.emoji}</span></h1>
				<p>{AboutMe.text}</p>
