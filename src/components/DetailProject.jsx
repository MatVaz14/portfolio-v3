  ...
  return (
    <div className="container-detail-project" data-aos="fade-right">
      <div className="header-detail">
        ...
        {Projects[position].url.length > 0 ? (
          <AiOutlinePlayCircle
      ...
      <div
        className={
          active === true && Projects[position].url.length > 0
            ? "verVideo"
            : "noVideo"
        }
      >
      ...
      <p className="style-description">{Projects[position].description}</p>
      <div className="container-links">
        <div className="container-link">
          {Projects[position].githubFull.length === 0 &&
          Projects[position].githubFront.length > 0 ? (
            <div>
              <span>GitHub (Front)</span>
              <a
                href={`${Projects[position].githubFront}`}
                target="_blank"
                className="active-click"
              >
                <BsGithub className="style-link" />
              </a>
            </div>
          ) : null}
          {Projects[position].githubFull.length === 0 &&
          Projects[position].githubBack.length > 0 ? (
            <div>
              <span>GitHub (Back)</span>
              <a
                href={`${Projects[position].githubBack}`}
                target="_blank"
                className="active-click"
              >
                <BsGithub className="style-link" />
          ...
          {Projects[position].deploy.length ? (
            <div>
              <span>Deploy </span>
              <a
                href={`${Projects[position].deploy}`}
                target="_blank"
                className="active-click"
              >
                <BiLinkExternal className="style-link" />
              </a>
            </div>
          ) : null}
          {Projects[position].githubFull.length > 0 &&
          ...
          Projects[position].githubBack.length === 0 ? (
            <div>
              <span>GitHub</span>
              <a
                href={`${Projects[position].githubFull}`}
                target="_blank"
                className="active-click"
              >
                <BsGithub className="style-link" />
